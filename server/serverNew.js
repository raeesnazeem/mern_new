...
const connectDB = require('./utils/db'); // Assuming your DB connection logic is here

const router = require('./router/authRouter'); // Assuming your auth routes
const tempRouter = require('./router/templateRouter'); // Assuming your template routes
...
if (NODE_ENV === 'production') {
  ...
  corsOptions = {
    ...
    credentials: true, // Set to true if your frontend sends cookies or Authorization headers that need to be processed
  };
